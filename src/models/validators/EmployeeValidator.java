...
public class EmployeeValidator {
    public static List<String> validate(Employee e, Boolean code_duplicate_check_flag, Boolean password_check_flag) {
        ...
        String classification_error = _validateclassification(e.getClassification());
        if(!classification_error.equals("")) {
        	errors.add(classification_error);
        }
    ...
    private static String _validateclassification(String classification) {
    	// 区分に設定が無い場合に実行
